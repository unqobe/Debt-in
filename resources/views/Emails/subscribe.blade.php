		          ...
		          <tr>
		            <td class="bg_white email-section">
		            	<div class="heading-section" style="padding: 40px 30px 0px 30px;">
		              	<h2>Successfully subscribed to our job alerts </h2>
		          ...
		          <tr>
		            <td class="bg_white email-section">
		            	<div class="heading-section" style="padding: 40px 30px 0px 30px;">
		              	...
		              	<p>Thank you for subscribing, be sure to be on the look out for new positions at Debt-in. </p>
              ...
              <tr>
                <td class="bg_white email-section">
                  <div class="heading-section" style="padding: 40px 30px 0px 30px;">
                    ...
                    <p>Kind Regards, <br/>303 Dr Pixley Kaseme Street <br/> Durban <br/>4001</p>
